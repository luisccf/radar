...
@WebServlet(name = "GetCriminalsStatisticsArmed", urlPatterns = {"/statistics/criminals/armed"})
public class GetCriminalsStatisticsArmed extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stat3.setId(3);
            stat3.setName("Arma de branca");
            stat3.setValue((int)incidentDAO.CountIncidentsByArmedCriminals(2));
            stats.add(stat3);
