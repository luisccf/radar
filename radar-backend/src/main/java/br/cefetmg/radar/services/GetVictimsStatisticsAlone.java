...
@WebServlet(name = "GetVictimsStatisticsAlone", urlPatterns = {"/statistics/victims/alone"})
public class GetVictimsStatisticsAlone extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stat1.setId(1);
            stat1.setName("Sim");
            stat1.setValue((int)incidentDAO.CountIncidentsByAloneVictims());
            stats.add(stat1);
            
            stat2.setId(2);
            stat2.setName("Não");
            stat2.setValue((int)incidentDAO.CountIncidentsByNotAloneVictims());
            stats.add(stat2);
