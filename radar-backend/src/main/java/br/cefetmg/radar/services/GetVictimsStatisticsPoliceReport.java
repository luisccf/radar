...
@WebServlet(name = "GetVictimsStatisticsPoliceReport", urlPatterns = {"/statistics/victims/policereport"})
public class GetVictimsStatisticsPoliceReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stat1.setId(1);
            stat1.setName("Sim");
            stat1.setValue((int)incidentDAO.CountIncidentsByHavingPoliceReport());
            stats.add(stat1);
            
            stat2.setId(2);
            stat2.setName("Não");
            stat2.setValue((int)incidentDAO.CountIncidentsByNotHavingPoliceReport());
            stats.add(stat2);
