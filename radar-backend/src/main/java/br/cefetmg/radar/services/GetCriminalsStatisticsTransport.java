...
@WebServlet(name = "GetCriminalsStatisticsTransport", urlPatterns = {"/statistics/criminals/transport"})
public class GetCriminalsStatisticsTransport extends HttpServlet {
        ...
        try {
            ...
            if(transports != null){
                ...
                for(int i = 0; i < transports.size(); i++){
                    ...
                    stat.setValue((int)incidentDAO.CountIncidentsByCriminalsTransportId(transports.get(i).getId()));
                    stats.add(stat);
                }
