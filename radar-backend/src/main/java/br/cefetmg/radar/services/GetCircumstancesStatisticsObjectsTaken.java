...
@WebServlet(name = "GetCircumstancesStatisticsObjectsTaken", urlPatterns = {"/statistics/circumstances/objectstaken"})
public class GetCircumstancesStatisticsObjectsTaken extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Statistic> stats = statisticDAO.GetStatistics();
